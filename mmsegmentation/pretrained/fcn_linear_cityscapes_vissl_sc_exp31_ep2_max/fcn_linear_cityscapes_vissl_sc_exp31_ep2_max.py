...
model = dict(
    ...
    vissl_params=dict(
        ...
        config_path='sc_exp31/dense_swav_8node_resnet_road_exp31.yaml',
        checkpoint_path='sc_exp31/model_final_checkpoint_phase1.torch',
        output_type='trunk',
...
work_dir = 'fcn_linear_cityscapes_vissl_sc_exp31_ep2_max'
gpu_ids = range(0, 8)
